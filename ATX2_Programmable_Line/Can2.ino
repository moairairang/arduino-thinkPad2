void Can2() {
  Forward(Speed, 100);
  TracJC(ACCSpeed, 70);  //เดินข้ามแยก1
  TracJC(ACCSpeed, 70);  //เดินข้ามแยก2
  ...
  TracJC(ACCSpeed, 70);  //เดินข้ามแยก8
  TracJC(ACCSpeed, 70);  //เดินข้ามแยก9
  TracJC(ACCSpeed, 70);  //เดินข้ามแยก 10
